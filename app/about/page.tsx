  ...
  return (
    <div className="py-12 px-5 about flex flex-col justify-center">
      <div className="flex flex-col items-center justify-center ">
        <h2 className="text-5xl py-6 mt-20 font-semibold">Who We Are</h2>
        <p className="text-sm pb-6">
          An outdated website means you are not engaging your customers and
      ...
      <div className="flex flex-row py-4 space-x-12 justify-center pb-12 relative">
        <div className="parent-div border border-gray-700 hover:border-green-800 w-5/12 py-2 p-4 rounded-lg flex flex-col justify-center h-48 hover:h-40 mt-3 cursor-pointer">
          ...
          <p className="text-sm">
            ...
            soluta, debitis officiis non sunt ipsa autem dolores molestiae
            incidunt reiciendis nulla!
          </p>
        </div>
        <div className=" parent-div border border-gray-700 hover:border-green-800  w-5/12 py-2 p-4 rounded-lg flex flex-col justify-center h-48 hover:h-40 mt-3 cursor-pointer">
          <Image
