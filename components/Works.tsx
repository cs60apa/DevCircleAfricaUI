  ...
  return (
    <div className='py-12  flex flex-col justify-center'>
      <div className='flex flex-col items-center justify-center pb-6 pl-20 pr-20'>
        <h2 className='text-5xl py-6 font-semibold'>Recent Works</h2>
        ...
        <div className='flex flex-row space-x-8 pb-8'>
          ...
          <Image
            ...
            <h5  className='text-xl pt-4 pb-3 p-0'>NFT Marketplace Development</h5>
            <p className='text-sm p-0'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid porro quia fugiat corporis omnis tenetur maxime magnam veniam soluta,</p>
          </div>
          <div className='bg-gray-800 rounded-xl p-4 hover:border hover:border-green-800 '>
          <Image
          ...
          <Image
            ...
            width={300} 
            className='rounded-lg h-52'/>
            <h5  className='text-xl pt-4 pb-3 p-0'>Car Marketplace Landing Page</h5>
            <p className='text-sm p-0'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid porro quia fugiat corporis omnis tenetur maxime magnam veniam soluta,</p>
          </div>
        </div>
        ...
        <div className='flex flex-row space-x-8 pb-8'>
          ...
          <Image
            ...
            width={300} 
            className='rounded-lg h-52'/>
            <h5  className='text-xl pt-4 pb-3 p-0'>Restaurant Responsive Website</h5>
            <p className='text-sm p-0'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid porro quia fugiat corporis omnis tenetur maxime magnam veniam soluta,</p>
          </div>
          <div className='bg-gray-800 rounded-xl p-4 hover:border hover:border-green-800 '>
          <Image
          ...
          <Image
            ...
            width={300} 
            className='rounded-lg h-52'/>
            <h5  className='text-xl pt-4 pb-3 p-0'>Responsive NFT Marketplace</h5>
            <p className='text-sm p-0'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid porro quia fugiat corporis omnis tenetur maxime magnam veniam soluta,</p>
          </div>
        </div>
